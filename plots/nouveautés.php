...
$totq->execute( array( $base100-$deltalines, $base100+$deltalines ) );
list( $tot100 ) = $totq->fetch( PDO::FETCH_NUM );
$antq->execute( array( $base100-$deltalines, $base100+$deltalines ) );
list( $ant100 ) = $antq->fetch( PDO::FETCH_NUM );
$postq->execute( array( $base100, $base100 ) );
list( $post100 ) = $postq->fetch( PDO::FETCH_NUM );
$premq->execute( array( $base100-($deltalines*2), $base100+($deltalines*2) ) );
...
for ( $date=$from; $date <= $to; $date++ ) {
  ...
  */
  ...
  echo "],\n";
    ...
    g.ready(function() {
      g.setAnnotations([
        { series: "Rééditions", x: "1648", shortText: "La Fronde", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1789", shortText: "1789", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1815", shortText: "1815", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1830", shortText: "1830", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1848", shortText: "1848", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1870", shortText: "1870", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1914", shortText: "1914", width: "", height: "", cssClass: "annl", },
        { series: "Rééditions", x: "1939", shortText: "1939", width: "", height: "", cssClass: "annl", },
      ]);
    });
