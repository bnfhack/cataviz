  ...
  <body>
    ...
    <header>
      <div class="links">
        ...
        | <a href="?from=1600&to=1750">Lumières</a>
        | <a href="?from=1740&to=1820">Révolution</a> 
        | <a href="?from=1850&to=1950&log=true">Grande-Guerre</a> 
      </div>
      <form name="dates">
  ...
  echo "],\n";
       ...
       ?>],
      {
        ...
        underlayCallback: function(canvas, area, g) {
          canvas.fillStyle = "rgba(255, 192, 128, 0.3)";
          var periods = [ [1870,1871], [1879,1882], [1914,1918], [1939,1945] ];
    ...
    g.ready(function() {
      g.setAnnotations([
        ...
        { series: "Hommes", x: "1694", shortText: "1694, Voltaire", width: "", height: "", cssClass: "ann45", },
        { series: "Hommes", x: "1712", shortText: "1712, Rousseau", width: "", height: "", cssClass: "ann45", },
        { series: "Hommes", x: "1743", shortText: "1743, Condorcet", width: "", height: "", cssClass: "ann45", },
        ...
        { series: "Hommes", x: "1905", shortText: "1905, Sartre", width: "", height: "", cssClass: "ann45", },
    ...
    <div class="text">
    <p>Ce graphique projette l’effectif des auteurs francophones à leur date de naissance, avec le ratio sexuel. Les effectifs sont parfois très faibles selon les périodes (1600 : 1 femme et 61 hommes), agitant les courbes de bruits accidentels. Une moyenne glissante variable a été appliquée, de +/- 10 ans pour les femmes avant 1750, à rien pour le XX<sup>e</sup> siècle. Cela permet d’obtenir des courbes lisibles sur <a href="?from=1500&to=1990&log=true">5 siècles</a>. La baisse des “naissances” après 1950 s’explique par un <a target="_blank" href="premier.php?from=1900&to=2015">âge moyen au premier livre</a> qui ne cesse d’augmenter, du moins, selon les données <i>Databnf</i>. Il n’y a probablement pas moins d’auteurs qui naissent après 1950, mais ils ne sont pas encore entrés au catalogue. Remarquons aussi que les femmes publient leur premier livre plus jeunes que les hommes. La parité pour les auteurs nés dans les années 1990 (la vingtaine) pourrait ne pas durer.</p>
    <p>Les <a href="?from=1600&to=1750&log=true">Lumières</a> s’illustrent non seulement par le nombre de titres, mais aussi par un nombre d’auteurs en croissance logarithmique. Le nombre de femmes croît aussi, mais sans modifier une proporion très basse, de 2 % à 4 %.</p>
    <p>La <a href="?from=1600&to=1750&log=true">Révolution</a> tranchera des têtes en 1793, et surtout <a href="mortalite.php?from=1760&to=1830" target="_blank">1794</a>. Cela peut suffire à explique une désaffection relative envers les lettres pour la génération de 1754 (35 ans en 1789), jusque Stendhal (né 1783). L’effet de rattrapage est ensuite très rapide pour la génération romantique. Sur un effectif assez stable de femmes auteur, les variations masculines suffisent à modifier des proportions relatives qui de toute façon restent faibles (5,5 % au maximum en 1783).</p>
    <p>Le traumatisme démographique de la <a href="?from=1850&to=1950&log=true">Grande-Guerre</a> crante la courbe des hommes et des femmes à naître, ce sont les auteurs qui n’ont pas été conçus pendant la mobilisation, jusque 1918 plus 9 mois (1919). Toutefois, le phénomène est relativement moins fort pour les femmes (l’échelle logarithmique permet de rendre les pentes comparables), car dans un contexte d’accès croissant à l’édition, même les générations de la guerre sont appelées à la carrière. Un cran similaire s’observe pour 1870, mais pas pour la guerre 1940 (exil ?). La guerre 1914 a aussi un effet sur la génération mobilisable (classes à 20 ans entre 1887 à 1919) ce qui explique ce faux plat dans les naissances entre 1867 et 1909. Sartre explique comment il a l’impression d’arriver dans un monde sans hommes, le laissant libre d’aller à sa carrière. Pour les femmes, la cause la plus importante de la croissance s’explique certainement par les différentes lois sur l’eneignement de la 3<sup>e</sup> République : 1879, École normale de jeunes filles dans tous les départements ; 1880, ouverture de la Sorbonne aux femmes, lycée de jeunes filles ; 1881, école obligatoire pour les garçon <i>et</i> les filles.</p>
    </div>
